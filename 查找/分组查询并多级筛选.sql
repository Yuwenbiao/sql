-- 首页显示3个商品，筛选规则为当前竞拍次数最多的商品，竞拍次数相同时优先显示竞拍剩余时间较短的，竞拍剩余时间相同则随机显示，且显示的商品必须为不同属性/面值的商品
-- 首页显示3个商品，筛选规则为当前最新上架的商品，不同属性/面值的商品仅显示一个，时间相同则优先显示竞拍价较低的，竞拍价相同则显示一口价较低的，竞拍价和一口价均相同则随机显示
SELECT
    *
FROM
    (
